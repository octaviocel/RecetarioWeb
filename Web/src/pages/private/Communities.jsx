          ...
          <div className="row">
              ...
              <div className="category-box-layout1">
                ...
                <div className="item-content">
                  <h3 className="item-title">
                    <a href="single-recipe1.html">Veganos</a>
                  </h3>
            ...
            <div className="col-lg-4 col-md-6 col-sm-6 col-12">
              <div className="category-box-layout1">
                ...
                <div className="item-content">
                  <h3 className="item-title">
                    <a href="single-recipe1.html">Diabetica</a>
                  </h3>
            ...
            <div className="col-lg-4 col-md-6 col-sm-6 col-12">
              <div className="category-box-layout1">
                ...
                <div className="item-content">
                  <h3 className="item-title">
                    <a href="single-recipe1.html">Carnivoros</a>
                  </h3>
            ...
            <div className="col-lg-4 col-md-6 col-sm-6 col-12">
              <div className="category-box-layout1">
                ...
                <div className="item-content">
                  <h3 className="item-title">
                    <a href="single-recipe1.html">Sin Gluten</a>
                  </h3>
            ...
            <div className="col-lg-4 col-md-6 col-sm-6 col-12">
              <div className="category-box-layout1">
                ...
                <div className="item-content">
                  <h3 className="item-title">
                    <a href="single-recipe1.html">Flexitariana</a>
                  </h3>
                  <span className="sub-title"> 14 Recetas</span>
                </div>
              </div>
            ...
            <div className="col-lg-4 col-md-6 col-sm-6 col-12">
              <div className="category-box-layout1">
                ...
                <div className="item-content">
                  <h3 className="item-title">
                    <a href="single-recipe1.html">Cetogénica</a>
                  </h3>
                  <span className="sub-title"> 14 Recetas</span>
                </div>
              </div>
