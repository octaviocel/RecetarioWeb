...
import Slide1 from "../../assets/img/slider/slide1-1.jpg";
import Slide2 from "../../assets/img/slider/slide1-2.jpg";
import Slide3 from "../../assets/img/slider/slide1-3.jpg";
          ...
          <div className="ranna-slider-content-layout1">
            ...
            <div className="item-content">
              ...
              <ul className="entry-meta">
                ...
                <li>
                  <a href="#">
                    <i className="fas fa-user"></i>by <span>John Martin</span>
                  </a>
                </li>
                <li>
                  <a href="#">
